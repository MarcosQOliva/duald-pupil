...
%   [percentEstimate, RT] = collectGlobalSelfReport(scr, visual, promptText)
%   shows a 0-100% continuous slider controlled with the mouse. The current
%   percentage is displayed under the scale and updates as the cursor
%   moves. Click (or press SPACE) to confirm.
...
while ~confirmed
    ...
    % confirmation via mouse click (edge triggered) or SPACE
